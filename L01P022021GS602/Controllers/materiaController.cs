...
namespace L01P022021GS602.Controllers
{
    ...
    public class materiaController : ControllerBase
    {
        ...
        public materiaController(notasContext notasContexto)
        {
        ...
        {
            List<Materia> listadoMateria = (from m in _notasContexto.materia
                                                  select m).ToList();

            if (listadoMateria.Count == 0)
            {
                return NotFound();
            }

            return Ok(listadoMateria);
        }
